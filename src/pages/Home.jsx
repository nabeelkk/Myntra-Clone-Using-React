    ...
    return (
        ...
        <title>Blanch Ecommerce</title>
            ...
            <main>
                ...
                <div className="img-link-container-4">
                    <a href=""><img
                ...
                <div className="img-link-container-5">
                    <a href=""><img
                ...
                <div className="img-link-container-6">
                ...
                <div className="img-link-container-7">
                    <a href=""><img
                ...
                <div className="text-banner-container">
                    <h4 className="text-banner-title">TRENDING IN SPORTS WEAR</h4>
                </div>

                <div className="img-link-container-8">
                    <a href=""><img
                ...
                <div className="text-banner-container">
                    <h4 className="text-banner-title">TRENDING IN FOOTWEAR</h4>
                </div>

                <div className="img-link-container-9">
                    <a href=""><img
                ...
                <div className="text-banner-container">
                    <h4 className="text-banner-title">TRENDING IN ACCESSORIES</h4>
                </div>
