                ...
                <div id="paymentBody">
                    <div>
                        <div id="paymentContent">
                            <div id="paymentContent-left">
                                <div className="bank-offer-div">
                                    <div className="offersV2-base-container"><svg xmlns="http://www.w3.org/2000/svg" width="18"
                                            height="18" viewBox="0 0 18 18" className="offersV2-base-discountIcon">
                                        ...
                                        <div className="offersV2-base-title">Bank Offers</div>
                                        <div>
                                            <li className="offersV2-base-message "> <span>10% Instant Discount on IDFC FIRST Bank
                                                    Cards on a min spend of Rs 2,500.TCA</span></li>
                                            <div className="offersV2-base-more">Show More<svg xmlns="http://www.w3.org/2000/svg"
                                                    width="7" height="12" viewBox="0 0 7 12" className="offersV2-base-arrowIcon"
                                ...
                                <div className="pay-mode">
                                    <div className="pay-mode-headline"> Choose Payment Mode </div>
                                    <div className="pay-mode-option">
                                        <div className="tabBar-base-tabsBlock">
                                            <div id="card" className="tabBar-base-selected tabBar-base-tab ">
                                                <span className="tabBar-base-tabLabel"><span
                                                        className="paymentOptions-base-tabDisplayContainer">
                                                        <div className="paymentOptions-base-tabDisplayIcon"><svg
                                                                xmlns="http://www.w3.org/2000/svg" width="18" height="12"
                                                                viewBox="0 0 20 14" prefix="">
                                                                <g fill="none" fillRule="evenodd" transform="translate(1 1)">
                                                                    <rect width="18" height="12" stroke="#FF3F6C" rx="1"></rect>
                                                                    <path fill="#FF3F6C" d="M0 3h18v2H0z"></path>
                                                                    <rect width="7" height="1" x="2" y="8" fill="#FF3F6C"
                                                                        rx=".5"></rect>
                                                                </g>
                                                            </svg>
                                                        </div>
                                                        <div>
                                                            <span className="paymentOptions-base-tabDisplayText">Credit/Debit
                                                                Card</span>
                                                        </div>
                                                    </span>
                                                </span>
                                            </div>
                                            <div id="cod" className=" tabBar-base-tab ">
                                                    ...
                                                    <span className="paymentOptions-base-tabDisplayContainer">
                                                        <div className="paymentOptions-base-tabDisplayIcon">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="14"
                                                                viewBox="0 0 24 16" prefix="">
                                                                <g fill="none" fillRule="evenodd"
                                                                    transform="rotate(-6 29.622 -5.581)">
                                                                    <path stroke="#000"
                                                        ...
                                                        <div>
                                                            <span className="paymentOptions-base-tabDisplayText">Cash On Delivery
                                                                (Cash/Card/UPI)</span>
                                                        </div>
                                                    </span>
                                                </span>
                                            </div>
                                            <div id="upi" className=" tabBar-base-tab ">
                                                <span className="tabBar-base-tabLabel">
                                                    <span className="paymentOptions-base-tabDisplayContainer">
                                                        <div className="paymentOptions-base-tabDisplayIcon"><svg
                                                                xmlns="http://www.w3.org/2000/svg" width="18" height="12"
                                                                viewBox="0 0 20 14" prefix="">
                                                                <g fill="none" fillRule="evenodd" transform="translate(1 1)">
                                                                    <rect width="18" height="12" stroke="#000" rx="1"></rect>
                                                                    <path fill="#000" fillRule="nonzero"
                                                                        d="M5.236 9.088c1.336 0 2.328-.744 2.328-2.28V3.48H6.188v3.344c0 .704-.312 1.112-.936 1.112-.616 0-.936-.416-.936-1.128V3.48H2.94v3.336c0 1.544.944 2.272 2.296 2.272zM9.876 9V7.168h.352c1.336 0 2.224-.64 2.224-1.888 0-1.2-.824-1.8-2.168-1.8H8.508V9h1.368zm.304-2.864h-.32V4.512h.344c.608 0 .92.264.92.792 0 .568-.336.832-.944.832zM14.524 9V3.48h-1.368V9h1.368z">
                                                                    </path>
                                                                </g>
                                                            </svg>
                                                        </div>
                                                        <div>
                                                            <span className="paymentOptions-base-tabDisplayText">PhonePe/Google
                                                                Pay/BHIM UPI</span>
                                                        </div>
                                                    </span>
                                                </span>
                                            </div>
                                            <div id="wallet" className=" tabBar-base-tab ">
                                                <span className="tabBar-base-tabLabel">
                                                    <span className="paymentOptions-base-tabDisplayContainer">
                                                        <div className="paymentOptions-base-tabDisplayIcon"><svg
                                                                ...
                                                                <g fill="#000" fillRule="nonzero">
                                                                    ...
                                                                    <path
                                                                        d="M12.813 9.813a.352.352 0 1 0 0 .703.352.352 0 0 0 0-.704zM5.219 3.836a.352.352 0 0 0 .351-.352V2.078a.352.352 0 1 0-.703 0v1.406c0 .195.158.352.352.352zM15.836 9.813h-1.617a.352.352 0 1 0 0 .703h1.617a.352.352 0 1 0 0-.704z">
                                                                    </path>
                                                                </g>
                                                            </svg>
                                                        </div>
                                                        <div>
                                                            <span
                                                                className="paymentOptions-base-tabDisplayText">Paytm/Wallets</span>
                                                        </div>
                                                    </span>
                                                </span>
                                            </div>
                                            <div id="netbanking" className=" tabBar-base-tab ">
                                                <span className="tabBar-base-tabLabel">
                                                    <span className="paymentOptions-base-tabDisplayContainer">
                                                        <div className="paymentOptions-base-tabDisplayIcon"><svg
                                                                xmlns="http://www.w3.org/2000/svg" width="18" height="16"
                                                                ...
                                                                <g fill="none" fillRule="evenodd">
                                                                    ...
                                                                    <path fill="#000"
                                                                        d="M3.375 7.188H4.5v6.187H3.375V7.75zM6.75 7.188h1.125v6.187H6.75zM10.125 7.188h1.125v6.187h-1.125zM13.5 7.188h1.125v6.187H13.5zM1.727 13.375h14.546c.376 0 .727.188.936.501l.558.837a.225.225 0 0 1-.187.35H.42a.225.225 0 0 1-.187-.35l.558-.837c.209-.313.56-.501.936-.501z">
                                                                    </path>
                                                                </g>
                                                            </svg>
                                                        </div>
                                                        <div>
                                                            <span className="paymentOptions-base-tabDisplayText">Net Banking</span>
                                                        </div>
                                                    </span>
                                                </span>
                                            </div>
                                            <div id="emi" className=" tabBar-base-tab ">
                                                <span className="tabBar-base-tabLabel">
                                                    <span className="paymentOptions-base-tabDisplayContainer">
                                                        <div className="paymentOptions-base-tabDisplayIcon"><svg
                                                                xmlns="http://www.w3.org/2000/svg" width="18" height="16"
                                                        ...
                                                        <div>
                                                            <span className="paymentOptions-base-tabDisplayText">EMI/Pay
                                                                Later</span>
                                                        </div>
                                                    </span>
                                                </span>
                                        ...
                                        <div className="pay-mode-option-right">
                                            <div>
                                                <form action="">
                                                    <div>
                                    ...
                                    <div className="gift-div">
                                        ...
                                        <span className="giftcard-base-title">Have a Gift Card?</span>
                                        <span className="giftcard-base-apply">APPLY GIFT CARD</span>
                                    </div>
                                </div>
                            </div>
                            {/* <div id="paymentContent-right">  */}
                                        ...
                                        <div className="priceBreakUp-base-orderSummary" id="priceBlock">
                                            <div className="priceDetail-base-row">
                                                ...
                                                <span className="priceDetail-base-value ">
                                                    <span></span>
                                                    <svg width="8" height="10" viewBox="0 0 8 10" className="priceDetail-base-icon">
                                            ...
                                            <div className="priceDetail-base-row">
                                                <span>Convenience Fee <div className="priceDetail-base-infoTextContainer">
